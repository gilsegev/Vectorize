...
class PromptProfile(str, Enum):
    ...
    stylized_v1_detail_preserving = "stylized_v1_detail_preserving"
    stylized_v2_balanced_cartoon = "stylized_v2_balanced_cartoon"
    stylized_v3_bold_cartoon = "stylized_v3_bold_cartoon"
    stylized_v4_graphic_poster = "stylized_v4_graphic_poster"
